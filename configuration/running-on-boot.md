...
The crontab will allow you to create [cronjobs](https://github.com/GameServerManagers/LinuxGSM-Docs/tree/88afc2c547969df2885aa9e148762ad5091478d2/configuration/cronjobs.md) that allow you to run a command on a set time or on boot. The below examples uses `@reboot` that will run a command on boot.
...
To learn more, see [cronjobs](https://github.com/GameServerManagers/LinuxGSM-Docs/tree/88afc2c547969df2885aa9e148762ad5091478d2/configuration/cronjobs.md) and [automated monitoring](../commands/monitor.md#automated-monitoring).
